...
Use this when the deliverable is a prompt and the wording itself is the main lever.
...
- **Handle modality deltas on purpose.** Image prompts, realtime prompts, and ordinary text-agent prompts each need different judgment about intent, degrees of freedom, and what must stay fixed.

If you want the operating rules, prompt shapes, and modality notes, jump to [`SKILL.md`](SKILL.md).
