...
`codex-goodies` is a public home for reusable Codex surfaces: shared `AGENTS.md` guidance, subagent definitions, hooks, and skills that are meant to be useful across machines and safe to publish.

## What's Here

- [`AGENTS.md`](AGENTS.md): shared working norms plus repository-specific guidance
