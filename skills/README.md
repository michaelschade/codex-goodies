...
- `codex-docs`: A Codex workflow and docs-navigation skill. It helps decide which behavior belongs in hooks, skills, `AGENTS.md`, config, automations, or a more programmatic Codex surface, and it keeps public-safe local-state guidance explicit.
