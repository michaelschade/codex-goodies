...
Keep this index current whenever a top-level agent role is added, removed, renamed, or meaningfully repurposed. `scripts/check-repo-hygiene.sh` verifies that every tracked agent entry is covered here.
