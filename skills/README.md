...
Keep this index current whenever a top-level skill directory is added, removed, renamed, or meaningfully repurposed. `scripts/check-public-safety.sh` verifies that every tracked skill is covered here.
